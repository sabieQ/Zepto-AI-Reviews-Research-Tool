/**
 * Phase 7a helper: fetch App Store reviews via app-store-scraper (Node).
 * Python app-store-scraper is currently broken against Apple's endpoints (2026).
 *
 * Usage:
 *   node fetch_app_store_reviews.js --app-id 1575323645 --country in --limit 50
 */
...
async function main() {
  ...
  // Paginate only for the working country
  if (all.length) {
